...
//
//     final roverPhotos = roverPhotosFromJson(jsonString);

import 'dart:convert';

RoverPhotos roverPhotosFromJson(String str) => RoverPhotos.fromJson(json.decode(str));

String roverPhotosToJson(RoverPhotos data) => json.encode(data.toJson());
...
class RoverPhotos {
  ...
  factory RoverPhotos.fromJson(Map<String, dynamic> json) => RoverPhotos(
